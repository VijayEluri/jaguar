 ...
 * @version 0.1
 */
public class StrIndexOutOfBoundsException extends Exception{
    /**
     * Constructor sin parámetros.
     * La excepcion presenta el mensaje por omisión, el cual es
     * <code></code>
     */ 
    public StrIndexOutOfBoundsException(){
	super();
    }
    /**
     * Constructor.
     ...
     */
    public StrIndexOutOfBoundsException(String mensaje){
	super(mensaje);
    }
}
/* StrIndexOutOfBoundsException.java ends here. */
