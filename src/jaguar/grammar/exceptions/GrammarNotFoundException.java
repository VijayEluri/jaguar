/**
** <GrammarNotFoundException.java> -- The exception used when a grammar is not found
**
...
public class GrammarNotFoundException extends Exception{
     ...
     */
    public GrammarNotFoundException(String mensaje){
        super(mensaje);
    }
}
/* GrammarNotFoundException.java ends here. */
