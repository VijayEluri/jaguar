...
/**
 * La interface para reemplazar símbolos
 *
 * @author Ivan Hernández Serrano <ivanx@users.sourceforge.net>
 * @version 0.1
 */
public class JGrammarSymbolReplacer extends JPanel{
    ...
    /**
     * Regresa una tabla de hash donde en la primer entrada está el símbolo a reemplazar y en la segunda entrada esta el nuevo símbolo .
     *
     */
