 ...
 * @version 0.1
 */
 public class ProductionNotValidTypeException extends Exception{
 /**
  * Constructor sin parámetros.
 * La excepcion presenta el mensaje por omisión, el cual es
 * <code></code>
 */ 
 public ProductionNotValidTypeException(){
 	  super("");
  }
  /**
   * Constructor.
   ...
   */
  public ProductionNotValidTypeException(String mensaje){
 	  super(mensaje);
  }
 }
/* ProductionNotValidTypeException.java ends here. */
