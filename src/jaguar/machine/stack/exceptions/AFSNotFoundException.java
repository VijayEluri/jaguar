...
package jaguar.machine.stack.exceptions;
 ...
 * @version 0.1
 */
public class AFSNotFoundException extends Exception{
    /**
     * Constructor sin parámetros.
     * La excepcion presenta el mensaje por omisión, el cual es
     * <code></code>
     */
    public AFSNotFoundException(){
  super();
    }
    /**
     * Constructor.
     ...
     */
    public AFSNotFoundException(String mensaje){
  super(mensaje);
    }
}
/* AFSNotFoundException.java ends here. */
