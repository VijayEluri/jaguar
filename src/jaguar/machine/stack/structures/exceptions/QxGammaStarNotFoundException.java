 ...
 * @version 0.1
 */
public class QxGammaStarNotFoundException extends Exception{
    /**
     * Constructor sin parámetros.
     * La excepcion presenta el mensaje por omisión, el cual es
     * <code></code>
     */
    public QxGammaStarNotFoundException(){
        super();
    }
    /**
     * Constructor.
     ...
     */
    public QxGammaStarNotFoundException(String mensaje){
        super(mensaje);
    }
}
/* QxGammaStarNotFoundException.java ends here. */
