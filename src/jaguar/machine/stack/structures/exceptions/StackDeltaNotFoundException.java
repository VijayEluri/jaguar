 ...
 * @version 0.1
 */
public class StackDeltaNotFoundException extends Exception{
    /**
     * Constructor sin parámetros.
     * La excepcion presenta el mensaje por omisión, el cual es
     * <code></code>
     */ 
    public StackDeltaNotFoundException(){
	super();
    }
    /**
     * Constructor.
     ...
     */
    public StackDeltaNotFoundException(String mensaje){
	super(mensaje);
    }
}
/* StackDeltaNotFoundException.java ends here. */
