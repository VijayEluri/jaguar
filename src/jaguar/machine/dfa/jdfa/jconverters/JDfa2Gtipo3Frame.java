...
public class JDfa2Gtipo3Frame extends JConverterFrame{    
	...
	jdfaOrig=new_jdfaOrig;
     ...
     /**
      * La gramática tipo3 equivalente al JDFA 
      */
    ...
    /**
     * El canvas donde solo dibujaremos la Gramática equivalente
     */
    ...
    /**
     * El frame donde pondremos el canvas de la gramática resultante
     */
	...
	return createMenu("Load DFA to Tranform...","Loads a new DFA to transform into a T3 Grammar ","Transform",
			  "Transform the loaded DFA to an equivalent T3 Grammar","Save  Grammar...", "Save the resulting Grammar");
    }
...
//		    JOptionPane.showInternalMessageDialog(this,"El resultado ha sido guardado!",
		    JOptionPane.showInternalMessageDialog(this,"The result has been saved!",
...
/* JDfa2Gtipo3Frame.java ends here. */
