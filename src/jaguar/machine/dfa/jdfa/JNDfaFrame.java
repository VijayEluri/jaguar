...
public class JNDfaFrame extends JMachineFrame{
    ...
    protected JMachine createNew() {
        ...
        JStateSet initials = new JStateSet();
        ...
        jmachine = new JNDFA(sigma, states, new JStateSet(), new JNDfaDelta(),  initials);
        ...
        ((JNDFA) jmachine).initStatesPosition(getJScrollPaneCanvas().getViewport().getViewSize());
        file = null;
