...
/**
 * representa la situacion en la que  La delta no tiene definida una transición
 * 
 * @author Ivan Hernández Serrano <ivanx@users.sourceforge.net>
 * @version 0.1
 */
public class DfaDeltaNotDefinedTransitionException extends Exception{
     ...
     * <code>La delta no tiene definida una transición</code>
     */ 
    public DfaDeltaNotDefinedTransitionException(){
	super("La delta no tiene definida una transición");
    }
    /**
     * Constructor.
