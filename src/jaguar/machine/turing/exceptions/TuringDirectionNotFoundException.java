...
* @version 0.1
*/
public class TuringDirectionNotFoundException extends Exception{
    /**
     * Constructor sin parámetros.
     * La excepcion presenta el mensaje por omisión, el cual es
     * <code></code>
     */
    public TuringDirectionNotFoundException(){
        super();
    }
    /**
    * Constructor.
    ...
    */
    public TuringDirectionNotFoundException(String mensaje){
        super(mensaje);
    }
}
/* TuringDirectionNotFoundException.java ends here. */
