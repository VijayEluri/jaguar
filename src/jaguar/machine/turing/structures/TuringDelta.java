 ...
 */
public class TuringDelta extends Delta<State,Hashtable<Symbol,QxGammaxDirection>>{
     /**
    ...
    public void removeTransition(State Qin, Symbol Tin){
     ...
     protected void addTransition(State Qin, Symbol Tin, QxGammaxDirection terciaResultante){
        Hashtable<Symbol,QxGammaxDirection> t = delta.get(Qin);
        if(t == null)
            t = new Hashtable<Symbol,QxGammaxDirection>();
    ...
    public Vector<Vector> getTransitions(State p){
        ...
        Hashtable<Symbol,QxGammaxDirection> t = delta.get(p);
        if(t == null){
            return v;
        }
